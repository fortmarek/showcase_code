...
open class SwipeViewController: UINavigationController, UIPageViewControllerDelegate, UIScrollViewDelegate, Navigation, BarButtonItem, SwipeButton, SelectionBar {
    ...
    open func setSwipeViewController(width: CGFloat) {
        
        navigationBar.barTintColor = navigationBarColor
        navigationBar.isTranslucent = false
        
        setPageController(width: width)
        ...
        pageController.navigationController?.navigationBar.topItem?.titleView?.isHidden = shouldBeHidden
        ...
        //pageScrollView.contentOffset.x = (CGFloat(currentPageIndex) - 1) * viewWidth
        
    }
    
    override open func viewWillAppear(_ animated: Bool) {
        setSwipeViewController(width: view.frame.width)
    }
    ...
    open func scrollViewDidScroll(_ scrollView: UIScrollView) {
        ...
        let xFromCenter = viewWidth - scrollView.contentOffset.x
    ...
    func setPageController(width: CGFloat) {
